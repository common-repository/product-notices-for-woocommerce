...
if ( ! class_exists( 'CRWCPN_Main' ) ) :
	...
	class CRWCPN_Main {
		...
		// @codingStandardsIgnoreLine
		/**
		 * @var CRWCPN_Admin_Post_Types class object
		 */
		private $admin_post_types;
		
		// @codingStandardsIgnoreLine
		/**
		 * @var CRWCPN_Notice_Meta_Boxes class object
		 */
		private $notice_meta_boxes;
		...
		public function define_constants() {
			...
			define( 'CRWCPN_VER', '1.3.3' );

			define( 'CRWCPN_AS_SLUG', 'product-notices-woocommerce' );

			// define for product notices custom post type.
			define( 'CRWCPN_PT_SLUG', 'product-notices-cpt' );
		}
		...
		private function includes() {
			...
			include $this->plugin_path() . '/includes/admin/class-crwcpn-admin-post-types.php';

			include $this->plugin_path() . '/includes/admin/class-crwcpn-notice-meta-boxes.php';
		}
		...
		private function init_hooks() {
			...
			$this->admin_post_types = new CRWCPN_Admin_Post_Types();
			$this->notice_meta_boxes = new CRWCPN_Notice_Meta_Boxes();
